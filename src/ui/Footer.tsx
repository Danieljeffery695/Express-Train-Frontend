...
const Footer: React.FC = () => {
  return (
    <div className="w-full h-375 pt-15 overflow-hidden">
      ...
      <div className="w-full h-125 text-center relative my-25 pt-15">
        <div className="min-h-22.5 h-50 max-w-75 absolute top-10 left-1/4 -translate-x-1/2 -translate-y-1/2">
          ...
          />
          {/* This image above will be use as background image with the size altered and position moved to the right coordinate like input field e.g SignUp */}
        </div>

        <h1 className="text-center text-[170px] leading-30 font-SairaStencil opacity-40">
          ADAPTIVE SKILLS <br /> TRAINING
        </h1>
      ...
      <div className="w-11/12 h-150 bg-white relative m-auto rounded transform-3d">
        <img
          src="testPhoto1.jpg"
          alt="photo"
          className="w-100 h-75 absolute left-1/4 -translate-x-1/2 -translate-y-full bg-red-400 -translate-z-0.5 object-cover"
        />
        <div className="w-full h-[30%] flex items-center justify-around z-3">
          ...
          <div className="flex-2 flex gap-2 justify-end px-10">
            ...
            <button className="w-35 h-13.75 rounded-4xl border-none bg-blue-500 text-xl font-Cafillen">
              Get Started
            </button>
          </div>
        </div>
        ...
        <div className="w-full h-[70%] flex items-center pt-5">
          <div className="h-[90%] w-4/5">
            <img
              ...
              alt="photo"
              className="w-[90%] h-full object-cover m-auto"
            />
          </div>
