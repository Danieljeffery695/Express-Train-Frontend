...
import type { ReducerState, ReducerAction } from "./SignUp";
...
const Login: React.FC = () => {
  ...
  const passwordInputFilter = state
    ...
    .at(-1);
  function showPassword( // function showing password value
  ...
  const handleCopyTextpwd = (e: React.ClipboardEvent<HTMLInputElement>) => {
    // stop users from copying any values from the password input field
    e.preventDefault();
  ...
  return (
    <div className="w-full h-[1100px] pt-10 bg-white">
      <LoginModal
      ...
      <div className="w-[90%] h-[900px] flex m-auto overflow-hidden rounded-4xl relative bg-[url(testPhoto1.jpg)] bg-fixed bg-cover bg-no-repeat test-test">
        <svg
        ...
        <div className="flex-1 z-10">
          ...
          <div className="w-full h-37.5 flex flex-col items-center justify-center gap-4">
            ...
            />
            <h2 className="text-2xl font-SuperSlice text-white">Login</h2>
          ...
          <form
            ...
            className="w-full h-[400px] flex flex-col gap-9 items-center justify-center gap-3"
          >
            <div
        ...
        <div className="flex-1 grid grid-cols-2 relative rounded-4xl z-10">
          ...
          <div className="w-[300px] h-full ml-auto relative">
            ...
            <div className=" w-[400px] h-[100px] -rotate-90 absolute top-[40%] translate-x-[50px]">
              <img
